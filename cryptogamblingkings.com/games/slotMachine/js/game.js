...
fetch('/api/user')
    ...
    .catch(error => {
        // This block will be executed if an error occurs at any point
...
function buildGameButton(){
	...
	// buttonBuyCrypto.cursor = "pointer";
	// buttonBuyCrypto.addEventListener("click", function(evt) {
	// 	if(slotData.spin){
	// 		return;  
	// 	}
	// 	// Show the checkout options when the button is clicked
